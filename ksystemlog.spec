...
Version  : 24.02.1
Release  : 64
URL      : https://download.kde.org/stable/release-service/24.02.1/src/ksystemlog-24.02.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.1/src/ksystemlog-24.02.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.1/src/ksystemlog-24.02.1.tar.xz.sig
...
%prep
%setup -q -n ksystemlog-24.02.1
cd %{_builddir}/ksystemlog-24.02.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1711041328
mkdir -p clr-build
pushd clr-build
