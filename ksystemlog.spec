...
Version  : 20.04.1
Release  : 20
URL      : https://download.kde.org/stable/release-service/20.04.1/src/ksystemlog-20.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.04.1/src/ksystemlog-20.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.04.1/src/ksystemlog-20.04.1.tar.xz.sig
...
%prep
%setup -q -n ksystemlog-20.04.1
cd %{_builddir}/ksystemlog-20.04.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1589837953
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksystemlog-20.04.1/COPYING %{buildroot}/usr/share/package-licenses/ksystemlog/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
pushd clr-build
%make_install
popd
