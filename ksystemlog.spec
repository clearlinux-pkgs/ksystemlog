...
Version  : 19.12.2
Release  : 17
URL      : https://download.kde.org/stable/release-service/19.12.2/src/ksystemlog-19.12.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/19.12.2/src/ksystemlog-19.12.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/19.12.2/src/ksystemlog-19.12.2.tar.xz.sig
...
%prep
%setup -q -n ksystemlog-19.12.2
cd %{_builddir}/ksystemlog-19.12.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1581031795
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksystemlog-19.12.2/COPYING %{buildroot}/usr/share/package-licenses/ksystemlog/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
pushd clr-build
%make_install
popd
