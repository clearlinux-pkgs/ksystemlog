...
Version  : 21.08.3
Release  : 33
URL      : https://download.kde.org/stable/release-service/21.08.3/src/ksystemlog-21.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/21.08.3/src/ksystemlog-21.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/21.08.3/src/ksystemlog-21.08.3.tar.xz.sig
...
%prep
%setup -q -n ksystemlog-21.08.3
cd %{_builddir}/ksystemlog-21.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1636066813
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksystemlog-21.08.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/ksystemlog/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/ksystemlog-21.08.3/COPYING %{buildroot}/usr/share/package-licenses/ksystemlog/a21ac62aee75f8fcb26b1de6fc90e5eea271854c
pushd clr-build
%make_install
popd
