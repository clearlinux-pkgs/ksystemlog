...
Version  : 22.04.3
Release  : 41
URL      : https://download.kde.org/stable/release-service/22.04.3/src/ksystemlog-22.04.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.04.3/src/ksystemlog-22.04.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.04.3/src/ksystemlog-22.04.3.tar.xz.sig
...
%prep
%setup -q -n ksystemlog-22.04.3
cd %{_builddir}/ksystemlog-22.04.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1657559135
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/ksystemlog-22.04.3/CMakePresets.json.license %{buildroot}/usr/share/package-licenses/ksystemlog/29fb05b49e12a380545499938c4879440bd8851e
cp %{_builddir}/ksystemlog-22.04.3/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/ksystemlog/f1946dab78e58c04c8c25ec6b074f5fc5c2830fe
cp %{_builddir}/ksystemlog-22.04.3/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/ksystemlog/82da472f6d00dc5f0a651f33ebb320aa9c7b08d0
cp %{_builddir}/ksystemlog-22.04.3/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/ksystemlog/3e8971c6c5f16674958913a94a36b1ea7a00ac46
pushd clr-build
%make_install
popd
